...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Human-machine interface applications for ASIBOT.")
set(CPACK_PACKAGE_DESCRIPTION_FILE "${CMAKE_SOURCE_DIR}/README.md")
set(CPACK_PACKAGE_CONTACT "Roboticslab team at UC3M")

# Package version.
set(CPACK_PACKAGE_VERSION_MAJOR "${ASIBOT_HMI_VERSION_MAJOR}")
set(CPACK_PACKAGE_VERSION_MINOR "${ASIBOT_HMI_VERSION_MINOR}")
set(CPACK_PACKAGE_VERSION_PATCH "${ASIBOT_HMI_VERSION_PATCH}")
...
if(WIN32 AND CMAKE_GENERATOR MATCHES "^Visual Studio")
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "asibot-hmi_${CPACK_PACKAGE_VERSION}_${CPACK_SYSTEM_NAME}")

    # Miscellanea.
    set(CPACK_NSIS_HELP_LINK "http://github.com/roboticslab-uc3m/asibot-hmi/")
...
if(UNIX)
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "asibot-hmi-${CPACK_PACKAGE_VERSION}.${CPACK_SYSTEM_NAME}")
endif()
